        ...
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              {/* صف الهاتف: صناديق موحدة الارتفاع = استواء تام */}
              <div className="flex items-center gap-3">
                <svg className="w-4 h-4 text-[#8B5CF6] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 7V5z" />
                </svg>
                <a
                  href="tel:+966580537317"
                  dir="ltr"
                  className="h-9 flex items-center text-sm font-medium text-[#F3F0EA] hover:text-[#8B5CF6] transition-colors"
                >
                  +966 58 053 7317
                </a>
                <a
                  ...
                  className="h-9 flex items-center gap-1.5 px-4 bg-[#8B5CF6]/15 border border-[#8B5CF6]/30 rounded-full text-xs text-[#F3F0EA] hover:bg-[#8B5CF6]/25 transition-all"
                >
          ...
          {/* الفوتر: كبسولة المصمم بصناديق موحدة = سطر واحد مستوٍ */}
